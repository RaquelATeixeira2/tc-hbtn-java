...
public class Consulta {
    ...
    public static Produto obterProdutoPrecoMinimo(List<Produto> produtos){
        Optional<Produto> produtosMaiorPreco = produtos.stream().min(Comparator.comparingDouble(Produto::getPreco));
        return produtosMaiorPreco.orElse(null);
    }
}
